...
3. **Make the change** — obey `arcade-build.instructions.md` (back-button href, single-file, palette, touch, `calebArcadeData`). Don't regress conventions to get a fix in.
